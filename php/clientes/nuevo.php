        ...
        <div class="panel-group"><div class="panel panel-primary">
            ...
            <div class="panel-body">
                ...
                <form class="form-horizontal" role="form"  id="fclientes">
                    ...
                    <div class="form-group">
                        <label class="control-label col-sm-2" for="Cliente_Codi">Nombre:</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="Cliente_Codi" name="Cliente_Codi" placeholder="Ingrese Nombre del empleado"
                            value = "">
                        </div>
                    </div>
